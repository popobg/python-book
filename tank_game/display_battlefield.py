...
class Display:
    ...
    def draw_battlefield(self):
        # create the list of lists for the battlefield
        self.__init_display__()
...
def calculate_move(d: Display):
    dy = 0.1 * d.get_height()
    dx = 0.1 * d.get_width()
    return dx, dy

def applicate_friction(dy, initial_dy):
    return (dy - initial_dy)
